    ...
    <div className='flex-1 p-4 md:p-10 bg-blue-50/50'>
      ...
      <div className='flex flex-wrap gap-4'>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-black'>{dashboardData.blogs}</p>
            <p className='text-black font-light'>Blogs</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-black'>{dashboardData.comments}</p>
            <p className='text-black font-light'>Comentarios</p>
          </div>
        </div>
        ...
        <div className='flex items-center gap-4 bg-white p-4 min-w-58 rounded shadow cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            <p className='text-xl font-semibold text-black'>{dashboardData.drafts}</p>
            <p className='text-black font-light'>Borradores</p>
          </div>
        </div>
      </div>
